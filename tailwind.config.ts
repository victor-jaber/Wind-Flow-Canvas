    ...
    extend: {
      ...
      keyframes: {
        ...
        "fabric-flutter": {
          ...
          "25%": { transform: "rotateY(2deg) scaleX(0.98)" },
          "50%": { transform: "rotateY(-1deg) scaleX(1.01)" },
          "75%": { transform: "rotateY(1deg) scaleX(0.99)" },
      ...
      animation: {
        ...
        "wind-wave": "wind-wave 3s ease-in-out infinite",
        "wind-wave-slow": "wind-wave-slow 4s ease-in-out infinite",
        "fabric-flutter": "fabric-flutter 2.5s ease-in-out infinite",
